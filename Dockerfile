...
#RUN RAILS_MASTER_KEY='5ac3acc78bcd6e544744cf977bebe212'
RUN RAILS_MASTER_KEY='7fe918500b973a11'
...
RUN apt-get update -qq && \
    apt-get install --no-install-recommends -y imagemagick libsqlite3-0 postgresql-client && \
